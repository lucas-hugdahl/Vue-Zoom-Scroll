(function (global, factory) {
    ...
    var __vue_staticRenderFns__ = [];
      ...
      var __vue_inject_styles__ = function (inject) {
        if (!inject) { return }
        inject("data-v-6453192e_0", { source: ".zoom-scroll__bg{position:relative;overflow:hidden}.zoom-scroll__content{position:absolute;left:0;height:100vh;width:100%;overflow:hidden}.zoom-scroll__content.fixed{position:fixed}.zoom-scroll__content.stickToBottom{bottom:0}.zoom-scroll__content.stickToTop{top:0}", map: undefined, media: undefined });
